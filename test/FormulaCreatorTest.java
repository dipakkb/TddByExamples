...
public class FormulaCreatorTest {
    ...
    public void shouldBuildSimpleFormulaForHydrogen() {
        ArrayList<IFormula> simpleFormula = FormulaCreator.createFormulas("H");
        assertEquals(new SimpleFormula(1, "H"), simpleFormula.get(0));
    }

    @Test
    public void shouldBuildSimpleFormulasForWater() {
        ArrayList<IFormula> simpleFormula = FormulaCreator.createFormulas("H2O");
    ...
    public void shouldBuildSimpleAndComplexFormulasForCalciumPhosphate() {
        ...
        ArrayList<IFormula> simpleFormula = FormulaCreator.createFormulas("Ca3(PO4)2");
    ...
    public void shouldBuildSimpleAndCompoundComplexFormulasForCobaltFerriCyanide() {
        ...
        ArrayList<IFormula> simpleFormula = FormulaCreator.createFormulas("Co3(Fe(CN)6)2");
